<template>
	<span type="button" class="icon-view">
		<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80.794 80.794" xml:space="preserve">
			<g>
...
<style lang="scss" scoped>
	.icon-view{
		display: flex;
		align-items: center;
		svg{width:20px; height:18px; margin-right:5px;}
	}
</style>